...
Input: data/exports/training-data-2026-06-16-to-2026-06-16-ascot.csv  
Generated: 2026-06-17T12:09:58.186Z  
Races: 7 · runners: 115 · settled races: 7
...
- Dataset: 7 race(s), 115 runner(s), 7 settled.
- Market favourite strike rate: +16.7%.
- Model-rank baseline strike rate: +16.7%; ROI: −67.2% (shadow model-rank baseline — NOT the production recommendation).
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| Market favourite | Pick the shortest-priced runner per race. | 7 | 6 | 1 | +16.7% | −67.2% | −4.03pt |
| Model-rank baseline (not production recommendation) | Pick model_rank_pre_off = 1 (else highest model_prob). Top model probability/rank only — NOT the persisted production recommendation. | 7 | 6 | 1 | +16.7% | −67.2% | −4.03pt |
| Highest EV | Pick the highest exported ev_pre_off per race. | 7 | 6 | 0 | 0.0% | −100.0% | −6.00pt |
...
- Brier score: 0.0570 (lower is better; null when no settled priced races)
- Log loss: 0.2240

| Prob bucket | Count | Mean predicted | Actual win rate |
| --- | --- | --- | --- |
| 0.00-0.20 | 101 | 0.045 | 0.059 |
| 0.20-0.40 | 7 | 0.272 | 0.000 |
| 0.40-0.60 | 1 | 0.503 | 1.000 |
| 0.60-0.80 | 0 | — | — |
| 0.80-1.00 | 0 | — | — |
...
| --- | --- | --- | --- | --- | --- |
| <3.0 | 1 | 1 | 1 | +100.0% | +97.0% |
| 3.0-8.0 | 6 | 5 | 0 | 0.0% | −100.0% |
