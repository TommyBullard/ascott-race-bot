# Nationwide write-boundary evidence — 2026-07-25 — after

Generated: 2026-07-25T16:47:33.912Z
...
| --- | --- | --- | --- |
| stored courses | `races` | `distinct course where races.meeting_date = <date>` | 7 |
| stored races | `races` | `races.meeting_date = <date> (direct)` | 51 |
| stored runners | `runners` | `runners.race_id -> races.meeting_date = <date>` | 527 |
| market snapshots | `market_snapshots` | `market_snapshots.race_id -> races.meeting_date = <date>` | 14 |
| runner quotes | `runner_quotes` | `runner_quotes.snapshot_id -> market_snapshots.race_id -> races.meeting_date = <date>` | 88 |
| cron/provider telemetry | `cron_runs` | `cron_runs.finished_at within the UTC calendar day of <date> — NOT a race relationship (cron_runs has no race_id/meeting_date)` | 2 |
