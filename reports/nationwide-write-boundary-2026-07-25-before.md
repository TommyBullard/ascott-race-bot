# Nationwide write-boundary evidence — 2026-07-25 — before

Generated: 2026-07-25T16:42:34.909Z
...
| --- | --- | --- | --- |
| stored courses | `races` | `distinct course where races.meeting_date = <date>` | 0 |
| stored races | `races` | `races.meeting_date = <date> (direct)` | 0 |
| stored runners | `runners` | `runners.race_id -> races.meeting_date = <date>` | 0 |
| market snapshots | `market_snapshots` | `market_snapshots.race_id -> races.meeting_date = <date>` | 0 |
| runner quotes | `runner_quotes` | `runner_quotes.snapshot_id -> market_snapshots.race_id -> races.meeting_date = <date>` | 0 |
| cron/provider telemetry | `cron_runs` | `cron_runs.finished_at within the UTC calendar day of <date> — NOT a race relationship (cron_runs has no race_id/meeting_date)` | 0 |
