...
### Warnings
- ⚠️ 54 post-off run(s) exist but were ignored (snapshot uses run_time <= off_time).
...
### Market favourite
- Confucius — odds 3.45 · EV +24.3%

### Alternatives
- Night In Vegas — odds 11.50 · EV +24.3%
- Bull Shark — odds 120.00 · EV +5.6%
...
### Warnings
- ⚠️ 48 post-off run(s) exist but were ignored (snapshot uses run_time <= off_time).
...
### Warnings
- ⚠️ 46 post-off run(s) exist but were ignored (snapshot uses run_time <= off_time).
...
### Warnings
- ⚠️ 44 post-off run(s) exist but were ignored (snapshot uses run_time <= off_time).
...
### Alternatives
- Tim Toe — odds 11.50 · EV +16.6%
- Barnso — odds 75.00 · EV −0.9%
...
### Warnings
- ⚠️ 39 post-off run(s) exist but were ignored (snapshot uses run_time <= off_time).
...
### Market favourite
- Haatem — odds 8.00 · EV +13.8%

### Alternatives
- Map Of Stars — odds 8.40 · EV +13.8%
- Nahraan — odds 8.20 · EV +13.8%
...
### Warnings
- ⚠️ 32 post-off run(s) exist but were ignored (snapshot uses run_time <= off_time).
...
### Market favourite
- Valiancy — odds 3.80 · EV +7.1%

### Alternatives
- Gamrai — odds 6.60 · EV +7.1%
- Valiancy — odds 3.80 · EV +7.1%
...
### Warnings
- ⚠️ 25 post-off run(s) exist but were ignored (snapshot uses run_time <= off_time).
